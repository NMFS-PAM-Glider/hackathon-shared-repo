...
from data import channel_columns, x_column
...
def link_figures(
    ...
    to carry the current zoom across a redraw.
    """
    ...
    if shows_db:
        ...
        # time. Sits top-left, clear of the legend at top-right.
        sub.add_annotation(
    ...
    sub.update_layout(
        ...
        height=470,
        margin=dict(l=55, r=20, t=80 if shows_db else 55, b=110 if has_heatmap else 50),
